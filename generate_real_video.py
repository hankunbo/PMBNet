...
# Target style
style_img = './cal_time/goeritz.jpg'

# Target content video
# Use glob.glob() to search for all the framess
# Add sort them by sort()
content_video = './cal_time/sunflower512/*.png'

# Path of the checkpoint (please download and replace the empty file)
checkpoint_path = "./Model/style_net-TIP-final-3.1.pth"
...
result_frames_path = './result_frames_time/'
result_videos_path = './result_videos_time/'
